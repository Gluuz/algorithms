# Problem: figure out the smallest set of stations
# you can play on to cover all 50 states
# Optimal solution O(2^n):
# List every possible subset of stations, pick the set
# with the smallest number of stations that cover all 50 states.
# Greedy solution O(n^2):
# Pick the station that covers the most
# uncovered states, repeat until all states are covered.
...
while states_needed: # Iterate until all states are covered
    ...
    # add the best station from each iteration to final set
